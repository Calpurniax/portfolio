...
export const Summary =()=>(
    <section className="summary">
        ...
        <div className="summary__box">         
            ...
            <SummaryContainer title="Experiencia" article={[{title:"Web developer", dates:"Enero - marzo 2024", text:"Diseño y creación de nuevas webs, mantenimiento, gestión del hosting "},
